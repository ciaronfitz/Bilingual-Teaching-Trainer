...
public struct NPCAction{
    ...
    [TextArea(5,20)]public string personality;
...
return instructions;
    ...
    public string buildActionInstructions(){
        string intstructions = " ";

        foreach (var item in actions){
            intstructions += "if i imply that I want you to do the following : " + item.actionDescription + ". You must add to your answer the following keyword : " + item.actionKeyword + ". \n";
        }
